...
Tavily is a search API — ek AI-first search engine jo real-time information, web results, aur context-aware data fetch karta hai. Ye mainly agents, LLMs aur AI assistants ke liye banaya gaya hai taake woh internet se fresh aur verified information la saken.
...
agent = Agent(name="Ratan lal",instructions="""
              ...
              -if user ask anything give answer using the Tool call
