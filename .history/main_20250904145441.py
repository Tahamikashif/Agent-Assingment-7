...
def Tavily():
 ...
 tavily_client = TavilyClient(api_key="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")
 response = tavily_client.search("give me Flood update from Pakistan Today news")
...
agent = Agent(name="Ratan lal",instructions="You are a helpful Assistant",model=Model,tools=[Tavily])
